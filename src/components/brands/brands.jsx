  ...
  return (<section className='brands'>
    <div className="container">
     <ul className="brands__list">
      <il><a href="#!"><img src={hm} alt="" /></a></il>
      <il><a href="#!"><img src={obey} alt="" /></a></il>
      <il><a href="#!"><img src={shopify} alt="" /></a></il>
      <il><a href="#!"><img src={lacoste} alt="" /></a></il>
      <il><a href="#!"><img src={levis} alt="" /></a></il>
      <il><a href="#!"><img src={amazon} alt="" /></a></il>
     </ul>
    </div>
  </section>);
}
